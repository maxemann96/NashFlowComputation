    ...
    def set_relation(self, relation):
        ...
        if relation == None:
            ...
            if isinstance(relation, str):
                ...
                try:
                    stringRelation = str(relation)
                    self._relation = stringRelation
                except Exception as exception:
                    raise TypeError(
                        "Type of label in Node object needs to be a string (or string castable): " + str(exception))
        ...
        if directed == None:
            ...
            if isinstance(directed, bool):
                ...
                try:
                    ...
                    raise TypeError(
                        "Type of directed in Edge needs to be a boolean (or boolean castable): " + str(exception))
