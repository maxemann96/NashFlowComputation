        ...
        if type == None:
            ...
            if isinstance(type, str):
                ...
                try:
                    ...
                    raise TypeError(
                        "Type of type in Graph object needs to be a string (or string castable): " + str(exception))
        ...
        if label == None:
            ...
            if isinstance(label, str):
                ...
                try:
                    ...
                    raise TypeError(
                        "Type of label in Graph object needs to be a string (or string castable): " + str(exception))
    ...
    def set_directed(self, directed=True):
        ...
        if directed == None:
            ...
            if isinstance(directed, bool):
                ...
                try:
                    boolDirected = bool(directed)
                    self._directed = boolDirected
                except Exception as exception:
                    raise TypeError(
                        "Type of directed in Graph needs to be a boolean (or boolean castable): " + str(exception))
